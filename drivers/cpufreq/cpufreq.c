...
unsigned int sysctl_pollo_threshold=5;
EXPORT_SYMBOL_GPL(sysctl_pollo_threshold);
unsigned int sysctl_pollo_size_threshold=200000; 
EXPORT_SYMBOL_GPL(sysctl_pollo_size_threshold);
			    ...
			    unsigned int relation)
{
	...
	//printk("sungwoo cpufreq_driver_target");
	 ...
	 * calls.
	 */
	if (target_freq == policy->cur && policy->poll_flag==0){
		//printk("sungwoo cpufreq_driver_target same out");
		return 0;
	}
	...
	if (cpufreq_driver->target){
		//printk("sungwoo cpufreq_driver_target 1");
	...
	//printk("sungwoo cpu_driver_target policy->poll_flag: %d, sysctl_pollo_size_threshold: %u, sysctl_pollo_threshold: %u", policy->poll_flag, sysctl_pollo_size_threshold, sysctl_pollo_threshold);
	//sungwoo modify
	//if (sysctl_pollo_size_threshold>=0 && policy->poll_flag>0){
	if(policy->poll_flag>0){
		//printk("changed");
